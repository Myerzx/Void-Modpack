...
Esta documentação define a plataforma de gerenciamento do servidor e atualização do modpack VoidFall. A Fase 1 registrou o plano; a Fase 2 implementou e validou a fundação; os itens 1 a 5 da Fase 3 foram concluídos, todos em recortes sem integração operacional.

...
- Fase 4 iniciada: contratos e reconciliador de inventário por SHA-256 validados localmente, aguardando matriz Windows/Linux e ainda sem integração operacional;

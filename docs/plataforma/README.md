...
- Fase 3 em andamento em `@voidfall/minecraft-process`, com planos, runtime, adaptadores e controlador serializado validados; o console limitado está implementado localmente e aguarda a matriz CI;

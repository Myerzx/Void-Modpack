...
- Fase 4 implementada em isolamento: inventário, classificação revisável, quarentena, arquivos autorizados, schemas genéricos e análise de conflitos passaram no gate local; a matriz Windows/Linux ainda precisa fechar o gate;

...
## Corpus Check
- 710 files · ~917,348 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6915 nodes · 12128 edges · 432 communities (390 shown, 42 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 170 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da902275`
...
- server_instances
- ecosystem-analysis-repositories.ts
- compilerOptions
...
## Communities (432 total, 42 thin omitted)
...
Cohesion: 0.07
Nodes (34): buildLocalProcessRuntime(), deriveKeys(), LocalAgentIdentity, LocalProcessRuntime, provisionLocalAgentIdentity(), provisionLocalInstance(), registerLocalAgent(), freePortFrom() (+26 more)
...
### Community 40 - "ecosystem-analysis-repositories.ts"
Cohesion: 0.31
Nodes (4): EcosystemAnalysisRepository, EcosystemAnalysisRow, mapRow(), StoredEcosystemAnalysis
...
Cohesion: 0.07
Nodes (18): LinuxMinecraftProcessAdapter, MinecraftProcessAdapter, ProcessOwnershipConflictError, ProcessOwnershipCoordinator, WindowsMinecraftProcessAdapter, MinecraftProcessControllerOptions, ProcessLaunchPlan, minimalEnvironment() (+10 more)
...
Cohesion: 0.13
Nodes (15): fastify, @fastify/cookie, dependencies, fastify, @fastify/cookie, @sinclair/typebox, @voidfall/authorized-files, @voidfall/configuration-staging (+7 more)
...
Cohesion: 0.11
Nodes (21): ActiveOperation, copyLaunchPlan(), ProcessControlAction, ProcessControlEventPhase, ProcessControlFailureCode, ProcessControlOutcome, ProcessControlRequest, ProcessControlRequestError (+13 more)
...
Cohesion: 0.07
Nodes (27): fixture(), NOW, resources, testClock(), analysis(), ANALYSIS_ID, INVENTORY_SHA256, NOW (+19 more)
...
Cohesion: 0.04
Nodes (27): ActiveSession, AgentRepository, AgentRow, asIso(), AuditEventRow, AuditRepository, isUniqueViolation(), JobRepository (+19 more)
...
### Community 221 - "Database"
Cohesion: 0.06
Nodes (21): AppendConsoleInput, ConsoleErrorCode, ConsolePersistenceError, ConsoleRepository, ConsoleRow, isoString(), mapLine(), Database (+13 more)
...
### Community 227 - "validateContract"
Cohesion: 0.08
...
Cohesion: 0.17
Nodes (16): CATEGORIES, modsSteps(), serverSteps(), ShellCategory, ShellStep, DatapacksPage(), ModsPage(), STATUS_LABEL (+8 more)
...
### Community 304 - "embedded.ts"
Cohesion: 0.22
Nodes (7): SqlResult, createEmbeddedDatabase(), databaseFromPGlite(), EmbeddedDatabaseUnavailableError, pgliteClient(), PGliteLike, PGliteQueryResult
...
### Community 326 - "console/page.tsx"
Cohesion: 0.17
Nodes (18): COMMAND_LABELS, ConsoleCommand, ConsolePage(), errorMessage(), panelFetch(), PollState, TIME_FORMAT, ConsoleLine (+10 more)
...
### Community 335 - "configuration-schemas.test.ts"
Cohesion: 0.14
...
### Community 338 - "workspace-client.ts"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (27): BuildControlApiOptions, ConfigurationValueReader, asDocument(), boundedLimit(), boundedOffset(), BuildReleaseBody, BuildReleaseSchema, ConfigurationChangeSchema (+19 more)
...
### Community 394 - "schedule-routes.ts"
Cohesion: 0.15
...
Cohesion: 0.40
Nodes (5): @electric-sql/pglite, devDependencies, @electric-sql/pglite, @voidfall/configuration-schemas, @voidfall/configuration-schemas

### Community 400 - "server-agent/src/process-operation.ts"
Cohesion: 0.21
...
### Community 406 - "compatibilidade/page.tsx"
Cohesion: 0.31
...
## Knowledge Gaps
- **2710 isolated node(s):** `name`, `version`, `private`, `description`, `license` (+2705 more)
...
- `Handoff da plataforma` (7× useful, score=6.554471315) _(code changed — re-verify)_
- `Roadmap, riscos e perguntas` (5× useful, score=4.73145077) _(code changed — re-verify)_
- `AgentRuntime` (4× useful, score=3.863261219)
- `DatapackLoadOrderRepository` (3× useful, score=2.998242283)
- `FilesystemBackupService` (3× useful, score=2.756912162)
- `FilesystemConfigurationService` (3× useful, score=2.542975547)
- `DatapackLoadOrderObservationCapability` (2× useful, score=1.999634701)
- `GuardedDatapackLoadOrderObserver` (2× useful, score=1.997621943)
- `BridgeCapabilities` (2× useful, score=1.916083151)
- `OperationRepository` (2× useful, score=1.909659339)

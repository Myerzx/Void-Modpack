...
## Corpus Check
- 619 files · ~834,874 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5994 nodes · 10088 edges · 382 communities (349 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 142 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `021c37cc`
...
- ScriptedProvider
- PermissionOperation
- AuthenticatedPermissionVerifier
...
## Communities (382 total, 33 thin omitted)
...
Cohesion: 0.09
Nodes (15): AcceptOperationInput, isoString(), mapOperation(), mapOutboxEvent(), mapProcessState(), ObserveProcessInput, OperationalErrorCode, OperationRepository (+7 more)
...
Cohesion: 0.06
Nodes (34): pg, dependencies, @electric-sql/pglite, pg, @voidfall/audit-chain, @voidfall/authentication, @voidfall/configuration-schemas, @voidfall/contracts (+26 more)
...
Cohesion: 0.12
Nodes (21): AgentTransportError, ArtifactReviewError, ConfigurationPersistenceError, MigrationRow, runMigrations(), ModCatalogPersistenceError, OperationalPersistenceError, PlayerIdentityPersistenceError (+13 more)

### Community 39 - "server_instances"
Cohesion: 0.07
Nodes (38): configuration_application_states, agent_nonces, agent_provision_tokens, agents, audit_events, job_events, jobs, panel_users (+30 more)

### Community 40 - "mod-catalog-repositories.ts"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (7): AgentTransportErrorCode, AgentTransportRepository, ClaimedWork, CredentialRow, isoString(), mapCredential(), ResolvedAgentIdentity
...
### Community 50 - "metadata.ts"
Cohesion: 0.20
Nodes (17): boundedText(), declaredDependenciesFor(), declaredEmbeddedLibraries(), declaredModsFromFabric(), declaredModsFromToml(), decodeUtf8(), normalizedSide(), parseJarManifest() (+9 more)
...
Cohesion: 0.06
Nodes (68): AgentEnvelope, AgentEnvelopeSchema, AgentHeartbeatPayload, AgentHeartbeatPayloadSchema, validateAgentEnvelope(), validateAgentHeartbeatPayload(), AuditChainExportManifest, AuditEvent (+60 more)
...
Cohesion: 0.12
Nodes (25): buildChangelog(), CONTENT_ROLES, describeMod(), renderChangelog(), diffInventories(), modsById(), APPROVED_REVIEWS, canExportCurseForgePack() (+17 more)
...
Cohesion: 0.13
Nodes (22): ConfigurationPage(), PanelSession, ConfigurationClient, createConfigurationClient(), buildConfigurationScreen(), capabilitiesFor(), changeEntriesFor(), computeSafeDiff() (+14 more)
...
Cohesion: 0.09
Nodes (10): WindowsMinecraftProcessAdapter, CommandTrackingHandle, compileJavaFixture(), execFileAsync, fakeControllerPlan, FakeMinecraftProcessAdapter, fixtureSource, javaExecutable (+2 more)

### Community 84 - "metrics.ts"
Cohesion: 0.11
Nodes (24): ProcessControlEvent, available(), AvailableMetric, createMinecraftMetricsSnapshot(), HostMetricsSample, HostMetricsSampler, MetricQuality, MetricSource (+16 more)
...
### Community 88 - "contracts/src/backup-operation.ts"
Cohesion: 0.13
Nodes (14): BackupIdempotencyKeySchema, BackupIdSchema, BackupPageContract, BackupPageSchema, BackupReasonCodeSchema, BackupRecordContract, BackupRecordSchema, BackupScopeContract (+6 more)
...
Cohesion: 0.09
Nodes (15): MinecraftProcessAdapter, ActiveOperation, copyLaunchPlan(), MinecraftProcessControllerOptions, ProcessControlAction, ProcessControlEventPhase, ProcessControlFailureCode, ProcessControlOutcome (+7 more)
...
### Community 111 - "MinecraftProcessController"
Cohesion: 0.42
Nodes (3): ProcessObservation, MinecraftProcessController, validateRequest()
...
Cohesion: 0.11
Nodes (24): MinecraftProcessAdapterOptions, COMMAND_LITERALS, createMinecraftConsoleSnapshot(), MINECRAFT_CONSOLE_COMMANDS, MinecraftConsoleCommand, minecraftConsoleCommandLiteral(), MinecraftConsoleCommandReceipt, MinecraftConsoleLine (+16 more)
...
Cohesion: 0.06
Nodes (68): AgentCapability, AgentCapabilitySchema, AgentCredential, AgentCredentialSchema, AgentCredentialStatus, AgentCredentialStatusSchema, AgentWorkClaimPayload, AgentWorkClaimPayloadSchema (+60 more)
...
### Community 143 - "local-session.ts"
Cohesion: 0.60
...
Cohesion: 0.04
Nodes (24): ActiveSession, AgentRepository, AgentRow, asIso(), AuditEventRow, AuditRepository, JobRepository, JobRow (+16 more)
...
Cohesion: 0.04
Nodes (60): AuditChainExportManifestSchema, AuditEventSchema, CreateBackupRequestSchema, RestoreBackupRequestSchema, schemaDirectory, schemas, ForgeBuildRequestSchema, JobSchema (+52 more)
...
Cohesion: 0.09
Nodes (20): operationEnvelope, PermissionFailureCode, PermissionFailureCodeSchema, PermissionGroupSchema, PermissionNodeSchema, PermissionNodeState, PermissionNodeStateSchema, PermissionOperation (+12 more)
...
Cohesion: 0.10
Nodes (35): VOIDFALL_TRUSTED_CONFIGURATION_REGISTRY, appendAuditRecord(), ACTOR_TYPES, actorRef(), asIso(), canonicalTimestamp(), CompletedConfigurationOperation, ConfigurationApplicationState (+27 more)
...
Cohesion: 0.15
Nodes (12): description, exports, files, license, name, private, scripts, build (+4 more)

### Community 216 - "launch-plan.ts"
Cohesion: 0.33
Nodes (9): assertPlainValue(), BACKSLASH, createForgeArgsFileProcessPlan(), createMinecraftProcessPlan(), ForgeArgsFileConfig, MinecraftProcessConfig, platformPath(), SupportedHostPlatform (+1 more)
...
Cohesion: 0.07
Nodes (32): ALLOWED_OPERATION_TRANSITIONS, DEFAULT_ADMINISTRATIVE_PAGE, IN_FLIGHT, isOperationInFlight(), MAXIMUM_ADMINISTRATIVE_PAGE, ObservedPidSchema, ObservedProcessLifecycle, ObservedProcessLifecycleSchema (+24 more)
...
Cohesion: 0.07
Nodes (54): PanelShell(), ShellStep, stepsFor(), Phase, SignInPage(), ConfigurationView(), describeConstraints(), displayValue() (+46 more)
...
### Community 226 - "local.ts"
Cohesion: 0.11
Nodes (23): freePortFrom(), localStateDirectory(), main(), panelExportDirectory(), provisionOwner(), config, database, panelExportExists() (+15 more)

### Community 227 - "configuration-api.test.ts"
Cohesion: 0.27
Nodes (7): ConfigurationValueReader, applyPayload(), digest(), fixture(), NOW, openLoaderDocument(), resources

### Community 228 - "dependencies"
Cohesion: 0.06
Nodes (39): fastify, @fastify/cookie, @fastify/helmet, @fastify/rate-limit, dependencies, fastify, @fastify/cookie, @fastify/helmet (+31 more)
...
### Community 248 - "configuration-worker.test.ts"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (45): AuditPage, panelFetch(), DANGEROUS, panelFetch(), ServerPage(), PanelFetch, PanelHttpResponse, PanelSessionClient (+37 more)
...
### Community 255 - "launcher-api/src/app.ts"
Cohesion: 0.10
Nodes (20): ArtifactParams, ArtifactParamsSchema, buildLauncherApi(), BuildLauncherApiOptions, ChannelParams, ChannelParamsSchema, correlationId(), fastify (+12 more)

### Community 256 - "ManagedMinecraftProcessAdapter"
Cohesion: 0.17
Nodes (5): BOOT_COMPLETED_PATTERN, LinuxMinecraftProcessAdapter, ManagedMinecraftProcessAdapter, MinecraftConsoleAdapter, MinecraftMetricsAdapter
...
### Community 258 - "control-api/src/app.ts"
Cohesion: 0.07
Nodes (28): AgentTransportVerifier, AgentWorkRouteDependencies, registerAgentWorkRoutes(), AgentRegistrationBody, AgentRegistrationBodySchema, AgentTransportVerifier, ApiError, AuthContext (+20 more)
...
### Community 270 - "backup-repositories.ts"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (16): FirstBootEvidence, RunIsolatedBootOptions, DiscoveredJava, discoverForgeArgsFile(), discoverJavaRuntime(), isFile(), javaBinaryName(), probe() (+8 more)
...
### Community 276 - "schedule-executor.ts"
Cohesion: 0.12
Nodes (8): createDurableScheduleExecutor(), DurableScheduleExecutorOptions, ScheduleStepFailureCode, SchedulerEvent, SchedulerLoopOptions, ScheduleStepExecutor, databases, NOW

### Community 277 - "server-agent/src/backup-operation.ts"
Cohesion: 0.19
Nodes (9): BackupCapabilityOptions, createBackupHandler(), createRestoreHandler(), leaseIsOurs(), RestoreCapabilityOptions, withExclusiveLock(), AgentSupervisor, LeaseHandlerResult (+1 more)
...
### Community 282 - "artifact-worker.ts"
Cohesion: 0.16
...
### Community 295 - "schedule-api.test.ts"
Cohesion: 0.32
...
Cohesion: 0.15
Nodes (3): createOfflineExclusiveConfigurationGuard(), AGENT_OWNED_ALERT_KINDS, AgentRuntime
...
### Community 303 - "claim-evidence.ts"
Cohesion: 0.18
Nodes (10): ClaimEvidence, ClaimEvidenceSchema, ClaimInvalidation, ClaimInvalidationSchema, MinecraftName, MinecraftNameSchema, SignedClaimEvidence, SignedClaimEvidenceSchema (+2 more)

### Community 304 - "sandbox.ts"
Cohesion: 0.14
Nodes (14): ComposedSandbox, listConfiguration(), removeTree(), renderServerProperties(), resolveInside(), Sandbox, SANDBOX_LEVEL_NAME, SandboxOptions (+6 more)
...
Cohesion: 0.13
Nodes (14): description, devDependencies, @voidfall/configuration-schemas, exports, license, name, private, scripts (+6 more)

### Community 310 - "PermissionOperation"
Cohesion: 0.29
Nodes (8): Envelope, GroupChange, ADD, REMOVE, NodeSet, NodeUnset, PermissionOperation, Rebind

### Community 311 - "AuthenticatedPermissionVerifier"
Cohesion: 0.33
Nodes (5): FunctionalInterface, PermissionVerifier, AuthenticatedPermissionVerifier, Override, SessionRegistry
...
Cohesion: 0.11
Nodes (18): @electric-sql/pglite, description, devDependencies, @electric-sql/pglite, @voidfall/configuration-schemas, license, name, private (+10 more)

### Community 316 - "planner.ts"
Cohesion: 0.12
...
### Community 317 - "server_instances"
Cohesion: 0.36
Nodes (7): player_aliases, player_identities, player_minecraft_claims, moderation_cases, player_profiles, player_identities, server_instances

### Community 318 - "release-planner/package.json"
Cohesion: 0.13
Nodes (14): bin, voidfall-release-package, description, exports, license, name, private, scripts (+6 more)
...
Cohesion: 0.13
Nodes (14): dependencies, @voidfall/configuration-inference, description, exports, files, license, name, private (+6 more)

### Community 324 - "configuration-staging/package.json"
Cohesion: 0.12
Nodes (16): description, exports, files, license, name, private, scripts, build (+8 more)
...
### Community 328 - "runIsolatedBoot"
Cohesion: 0.20
Nodes (5): main(), BOOTABLE_ROLES, runIsolatedBoot(), sandboxTargetPath(), ChangeVerification
...
### Community 331 - "Database"
Cohesion: 0.12
Nodes (8): AppendConsoleInput, ConsoleErrorCode, ConsolePersistenceError, ConsoleRepository, ConsoleRow, isoString(), mapLine(), Database

### Community 332 - "dependencies"
Cohesion: 0.12
Nodes (17): @voidfall/configuration-inference, @voidfall/configuration-staging, @voidfall/workspace-inventory, @voidfall/minecraft-process, dependencies, @voidfall/configuration-inference, dependencies, @voidfall/workspace-inventory (+9 more)

### Community 333 - "build-worker/package.json"
Cohesion: 0.12
Nodes (15): description, devDependencies, @electric-sql/pglite, exports, @electric-sql/pglite, license, name, private (+7 more)
...
Cohesion: 0.18
Nodes (7): createProcessSandboxBootRunner(), ProcessSandboxBootRunnerOptions, StopDisposition, SandboxBootOutcome, SandboxError, SandboxErrorCode, SandboxSourceRole

### Community 340 - "sandbox-runner.test.ts"
Cohesion: 0.13
Nodes (3): FILES, roots, ScriptedProcess
...
### Community 351 - "test/**/*.ts"
Cohesion: 0.40
Nodes (5): include, src/**/*.ts, include, src/**/*.ts, test/**/*.ts
...
### Community 353 - "server-schedule.ts"
Cohesion: 0.14
...
Cohesion: 0.17
Nodes (11): description, exports, license, name, private, scripts, build, test (+3 more)

### Community 355 - "artifact-e2e.test.ts"
Cohesion: 0.20
...
Cohesion: 0.27
Nodes (10): ALREADY_COMPRESSED, ArchiveEntry, ArchiveErrorCode, ArchiveReceipt, CentralRecord, copyStored(), dosDateTime(), entryNameBytes() (+2 more)
...
Cohesion: 0.10
Nodes (15): asDocument(), ConfigurationChangeSchema, ConfigurationValue, InventoryDocument, RegisterWorkspaceBody, registerWorkspaceRoutes(), RegisterWorkspaceSchema, WorkspaceConfigurationService (+7 more)

### Community 361 - "Consequências"
Cohesion: 0.10
Nodes (19): ADR-015 — Frente de integração do painel, em paralelo ao roadmap, Consequências, Contexto, Decisão, Editar, validar, preparar e ver a diferença, Execução real, Execução real, do painel ao JVM, O ambiente local é do projeto, não do operador (+11 more)

### Community 362 - "dependencies"
Cohesion: 0.15
Nodes (13): dependencies, @voidfall/artifact-compatibility, @voidfall/artifact-inspection, @voidfall/contracts, @voidfall/database, @voidfall/contracts, @voidfall/database, devDependencies (+5 more)

### Community 363 - "schedule-routes.ts"
Cohesion: 0.15
...
### Community 364 - "configuration-client.ts"
Cohesion: 0.18
Nodes (7): ConfigurationAcceptanceView, ConfigurationApiError, ConfigurationApiFailure, ConfigurationApplyInput, ConfigurationRollbackInput, ConfigurationSession, Fetcher

### Community 365 - "contracts.test.ts"
Cohesion: 0.20
Nodes (3): hashA, hashB, signature

### Community 366 - "artifact-inspection/src/service.ts"
Cohesion: 0.15
Nodes (16): DEEP_UNKNOWNS, InspectArtifactPlan, KNOWN_DESCRIPTOR_PATHS, STRUCTURAL_UNKNOWNS, ArtifactInspectionError, ArtifactInspectionErrorCode, ArtifactInspectionStage, DeclaredLoader (+8 more)

### Community 367 - "zip.ts"
Cohesion: 0.21
Nodes (15): findEntry(), STRUCTURAL_CAPACITY_LIMITS, ArtifactInspectionReport, ExpansionBudget, hasControlCharacter(), locateEndOfCentralDirectory(), readZipDirectory(), readZipEntry() (+7 more)

### Community 368 - "configuration-e2e.test.ts"
Cohesion: 0.31
...
### Community 371 - "artifact-inspection.test.ts"
Cohesion: 0.22
Nodes (4): FixtureEntry, FORGE_MODS_TOML, MANIFEST, NOW

### Community 372 - "layered-inspection.test.ts"
Cohesion: 0.25
Nodes (3): FixtureEntry, MODS_TOML, NOW

### Community 373 - "ArtifactInspectionLimits"
Cohesion: 0.33
Nodes (5): ArtifactInspectionService, ArtifactInspectionServiceOptions, readSelectedEntries(), resolveLimits(), ArtifactInspectionLimits

### Community 375 - "control-api/src/config.ts"
Cohesion: 0.47
Nodes (4): database, ControlApiConfig, parseBoolean(), readControlApiConfig()

### Community 376 - "telemetry-routes.ts"
Cohesion: 0.18
...
### Community 377 - "Os cinco buracos"
Cohesion: 0.18
Nodes (10): 1. O agente monta o plano errado, 2. Não existe detecção de runtime, 3. Workspace e instância não se falam, 4. O ambiente local não sobe o agente, 5. Nenhuma tela, O que continua desligado de propósito, O que já está pronto, Ordem de execução (+2 more)
...
Cohesion: 0.67
Nodes (3): panel_workspaces, workspace_sandbox_runs, workspace_staged_changes

### Community 380 - "console-operation.ts"
Cohesion: 0.24
Nodes (4): captureConsole(), ConsoleCommandCapabilityOptions, createConsoleCommandHandler(), NOW

### Community 381 - "audit-chain/src/canonical.ts"
Cohesion: 0.60
Nodes (4): canonicalJson(), compareOrdinal(), freezeRecursive(), visit()

## Knowledge Gaps
- **2415 isolated node(s):** `Contexto`, `1. O painel é o gerenciador completo, e o ADR-014 descrevia ordem, não escopo`, `2. Workspace e instância são coisas diferentes, e a diferença é a que permite ligar o servidor`, `3. O runtime deixa de ser Forge`, `4. Mundo, gamerules e `server.properties` ganham áreas próprias` (+2410 more)
...
- `FilesystemConfigurationService` (3× useful, score=2.718401882)
- `ConfigurationRepository` (2× useful, score=1.855115326)
- `OperationalLockRepository` (2× useful, score=1.855115326)
- `PersistentConfigurationService` (2× useful, score=1.855115326)
- `Handoff da plataforma` (2× useful, score=1.850694761)
- `ConfigurationRevisionManifest` (2× useful, score=1.812312485)
- `RollbackConfigurationPlan` (2× useful, score=1.812312485)
- `CatalogReconciliationReportSchema` (2× useful, score=1.8119044)
- `mod-catalog.test.ts` (2× useful, score=1.8119044)
- `ModCatalogEntrySchema` (2× useful, score=1.811706291)
...
- **Why does `computeAuditEventHash()` connect `chain.ts` to `authorized-files/src/service.ts`, `audit-chain/src/canonical.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **What connects `Contexto`, `1. O painel é o gerenciador completo, e o ADR-014 descrevia ordem, não escopo`, `2. Workspace e instância são coisas diferentes, e a diferença é a que permite ligar o servidor` to the rest of the system?**
